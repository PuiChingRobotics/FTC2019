...
@TeleOp(name="FTC_2020_summertesting_manual", group="FTC 2020")
public class FTC_2020_summertesting_manual extends OpMode {

    FTC_2020_summertesting_init robot = new FTC_2020_summertesting_init();
